...
function SocketPouch(opts, callback) {
  ...
  function createNewSocket() {
    ...
    function checkBinaryReady(uuid) {
      ...
      msg.cb(null, blobUtil.createBlob([blob], {type: msg.contentType}));
    }
  ...
  api._query = utils.adapterFun('query', function (fun, opts, callback) {
    if (typeof opts === 'function') {
      callback = opts;
      opts = {};
    }
  ...
  api._viewCleanup = utils.adapterFun('viewCleanup', function (callback) {
