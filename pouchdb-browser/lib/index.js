...
function readAttachmentsAsBlobOrBuffer(row) {
  ...
  Object.keys(atts).forEach(function (filename) {
    ...
    if (!att.data) {
      throw new Exception('IN readAttachmentsAsBlobOrBuffer, att data undefined, doc was: ', JSON.stringify(row.doc, null, 2));
    }
  ...
  function readAttachmentsAsBlobOrBuffer(res) {
    res.rows.forEach(function (row) {
      ...
      Object.keys(atts).forEach(function (filename) {
        var att = atts[filename];
        if (!att.data) {
          throw new Exception('IN readAttachmentsAsBlobOrBuffer2, att data undefined, doc was: ', JSON.stringify(row.doc, null, 2));
        }
