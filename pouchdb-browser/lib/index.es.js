...
function readAttachmentsAsBlobOrBuffer(row) {
  ...
  Object.keys(atts).forEach(function (filename) {
    ...
    if (!att.data) {
      throw new Error('IN readAttachmentsAsBlobOrBuffer 3, att data undefined, doc was: ' + JSON.stringify(row.doc, null, 2));
    }
  ...
  function readAttachmentsAsBlobOrBuffer(res) {
    res.rows.forEach(function (row) {
      ...
      Object.keys(atts).forEach(function (filename) {
        var att = atts[filename];
        if (!att.data) {
          throw new Error('IN readAttachmentsAsBlobOrBuffer 4, att data undefined, doc was: ' + JSON.stringify(row.doc, null, 2));
        }
